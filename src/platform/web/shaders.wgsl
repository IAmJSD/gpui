// Derived from platform/blade/shaders.wgsl. Blade injects resource bindings;
// raw wgpu requires explicit @group/@binding on every module-scope resource.
// The macOS video-surface pipeline (vs_surface/fs_surface) is removed: the web
// backend has no CoreVideo surfaces.
...
// Padded to vec4 for 16-byte uniform alignment; only .x is meaningful.
@group(0) @binding(2) var<uniform> grayscale_enhanced_contrast: vec4<f32>;
@group(0) @binding(3) var t_sprite: texture_2d<f32>;
@group(0) @binding(4) var s_sprite: sampler;
...
@group(0) @binding(5) var<storage, read> b_quads: array<Quad>;
...
@group(0) @binding(6) var<storage, read> b_shadows: array<Shadow>;
...
@group(0) @binding(7) var<storage, read> b_path_vertices: array<PathRasterizationVertex>;
...
@group(0) @binding(8) var<storage, read> b_path_sprites: array<PathSprite>;
...
@group(0) @binding(9) var<storage, read> b_underlines: array<Underline>;
...
@group(0) @binding(10) var<storage, read> b_mono_sprites: array<MonochromeSprite>;
...
@group(0) @binding(11) var<storage, read> b_poly_sprites: array<PolychromeSprite>;
